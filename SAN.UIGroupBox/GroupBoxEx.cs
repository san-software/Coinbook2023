	...
	public class GroupBoxEx : System.Windows.Forms.UserControl
	{
		...
		private void PaintGroupText(System.Drawing.Graphics g)
		{
			...
			else
			{
				...
				{
					BackgroundGradientBrush = new LinearGradientBrush(new Rectangle(0, 0, this.Width, this.Height), Color.LightGray, 
			...
			else
			{
				...
				else
				{
					BackgroundGradientBrush = new LinearGradientBrush(new Rectangle(0,0,this.Width,this.Height),
						Color.LightGray, this.BackgroundGradientColor, (LinearGradientMode)this.BackgroundGradientMode);
		...
		public new bool Enabled
		{
			...
			set
			{
				...
				foreach (System.Windows.Forms.Control c in base.Controls)
				{
