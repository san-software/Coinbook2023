...
namespace Splash
{
	...
	public partial class SplashScreen : Form
	{
      ...
      BackgroundImage = Image.FromFile(Path.Combine( Application.StartupPath,"in_cb_de001.gif"));
		...
		public static string Lizenz { get; set; }
    ...
    private void SetReferenceInternal()
      ...
      if (m_alPreviousCompletionFraction != null && m_iIndex < m_alPreviousCompletionFraction.Count)
		...
		public static void FormVisible(bool visible)
		{
			ms_frmSplash.Visible = visible;
		}
		...
		private void UpdateTimer_Tick(object sender, System.EventArgs e)
    {
      ...
      if (width > 0 && height > 0)
      {
        ...
        m_sTimeRemaining = (iSecondsLeft == 1) ? string.Format("noch 1 Sekunde") : string.Format("noch {0} Sekunden", iSecondsLeft);
	...
	internal class SplashScreenXMLStorage
	{
      ...
      get 
      { 
        return Path.Combine(@"C:\Programdata\Coinbook", ms_StoredValues); 
      }
    }
