    ...
    public static class CoinbookHelper
    {
        ...
        public static BindingList<Katalog3> MuenzkatalogFiltered
        {
            get
            {
                ...
                string alle = LanguageHelper.Localization.GetTranslation("Keys", "alle");
        ...
        public static int StartProgram(string program, enmPrograms param, string connectionString)
        {
            ...
            switch (param)
            {
                ...
                case enmPrograms.AboBestellung:
                    process.StartInfo.Arguments += " " + DataPath + " " + connectionString;
                    break;

                default:
                    process.StartInfo.Arguments += " xxx " + connectionString;
                    break;
            }
