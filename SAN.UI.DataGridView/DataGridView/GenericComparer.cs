...
namespace SAN.UI.DataGridView
{
    ...
    public class GenericComparer : IComparer
    {
        ...
        public int Compare(object x, object y)
        {
            ...
            {
                PropertyDescriptor propertyDescriptor = sortDescriptions[i].PropertyDescriptor;
                ...
                if (result != 0)
                    return sortDescriptions[i].SortDirection == ListSortDirection.Ascending ? result : -result;
            }
