...
namespace SAN.UI.DataGridView //AllocationRequest
{    
    ...
    public class DGVPrinter
    {
        ...
        /// <returns></returns>
        public StringFormat GetRowHeaderCellFormat(System.Windows.Forms.DataGridView grid)
        {
        ...
        /// Allow override of the header cell format object
        /// </summary>
        private Dictionary<string, DataGridViewCellStyle> columnheaderstyles = new Dictionary<string, DataGridViewCellStyle>();
        ...
        /// <param name="grid"></param>
        /// <returns></returns>
        public StringFormat GetColumnHeaderCellFormat(System.Windows.Forms.DataGridView grid)
        {
            // get default values from provided data grid view, but only
            // if we don't already have a header cell format
        ...
        /// <param name="grid"></param>
        /// <returns></returns>
        public StringFormat GetCellFormat(System.Windows.Forms.DataGridView grid)
        {
            // get default values from provided data grid view, but only
        ...
        /// <param name="withPrintDialog">The DataGridView to print</param>
        /// NOTE: Any changes to this method also need to be done in PrintPreviewDataGridView
        public void PrintDataGridView(System.Windows.Forms.DataGridView dgv, bool withPrintDialog)
        {
            ...
            if (!(typeof(System.Windows.Forms.DataGridView).IsInstanceOfType(dgv)))
        ...
        public void PrintPreviewDataGridView(System.Windows.Forms.DataGridView dgv)
        {
        ...
        public void PrintNoDisplay(System.Windows.Forms.DataGridView dgv)
        {
        ...
        /// </summary>
        /// <param name="dgv"></param>
        public void PrintPreviewNoDisplay(System.Windows.Forms.DataGridView dgv)
        {
        ...
        public Boolean EmbeddedPrint(System.Windows.Forms.DataGridView dgv, Graphics g, Rectangle area)
        {
        ...
        /// <param name="area"></param>
        /// <exception cref="Exception"></exception>
        public void EmbeddedPrintMultipageSetup(System.Windows.Forms.DataGridView dgv, Rectangle area)
        {
        ...
        /// <param name="overridewidth">Column index of cell being measured</param>
