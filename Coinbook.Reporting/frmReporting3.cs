...
namespace Coinbook
{
    partial class frmReporting : Form
    {
        ...
        public new void ShowDialog()
        {
            ...
            foreach (Model.Nation item in CoinbookHelper.Nationen)
        ...
        private void cboNation_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cboNationen.SelectedValue != null)
            {
                ...
                aeras.Clear();
                aeras.Add(new KeyValuePair<int, string>(0, "(alle Äras)"));
                List<Model.Aera> temp = CoinbookHelper.GetAeras(nation);
        ...
        private void cboÄra_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cboÄra.SelectedValue != null)
            {
                ...
                gebiete.Clear();
                gebiete.Add(new KeyValuePair<int, string>(0, "(alle Gebiete)"));
                List<Model.Gebiet> temp = CoinbookHelper.GetRegions(gebiet);
        ...
        private void reportTable(int nationID, int äraID, int gebietID)
        {
            ...
            dtReport = Database.Database.Instance.Reporting(Liste, nationID, äraID, gebietID, CoinbookHelper.Settings.Preise, CoinbookHelper.Settings.CurrentFaktor);
        ...
        private void btnCSV_Click(object sender, EventArgs e)
        {
            ...
            if (dlgSave.ShowDialog() != DialogResult.Cancel)
            {
                CoinbookHelper.WriteDataTable(dlgSave.FileName, dtReport, ';');
        ...
        private void showReport()
        {
            ...
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["SPREIS"].HeaderText = CoinbookHelper.Erhaltungsgrade[0].Erhaltung + "\n[" + CoinbookHelper.Settings.CurrentWährung + "]";
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["SPPREIS"].HeaderText = CoinbookHelper.Erhaltungsgrade[1].Erhaltung + "\n[" + CoinbookHelper.Settings.CurrentWährung + "]";
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["SSPREIS"].HeaderText = CoinbookHelper.Erhaltungsgrade[2].Erhaltung + "\n[" + CoinbookHelper.Settings.CurrentWährung + "]";
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["SSPPREIS"].HeaderText = CoinbookHelper.Erhaltungsgrade[3].Erhaltung + "\n[" + CoinbookHelper.Settings.CurrentWährung + "]";
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["VZPREIS"].HeaderText = CoinbookHelper.Erhaltungsgrade[4].Erhaltung + "\n[" + CoinbookHelper.Settings.CurrentWährung + "]";
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["VZPPREIS"].HeaderText = CoinbookHelper.Erhaltungsgrade[5].Erhaltung + "\n[" + CoinbookHelper.Settings.CurrentWährung + "]";
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["STNPREIS"].HeaderText = CoinbookHelper.Erhaltungsgrade[6].Erhaltung + "\n[" + CoinbookHelper.Settings.CurrentWährung + "]";
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["STHPREIS"].HeaderText = CoinbookHelper.Erhaltungsgrade[7].Erhaltung + "\n[" + CoinbookHelper.Settings.CurrentWährung + "]";
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["PPPREIS"].HeaderText = CoinbookHelper.Erhaltungsgrade[8].Erhaltung + "\n[" + CoinbookHelper.Settings.CurrentWährung + "]";

            grdAnzeige.GetTableDescriptor("ReportTable").Columns["SP"].HeaderText = CoinbookHelper.Erhaltungsgrade[1].Erhaltung;
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["SSP"].HeaderText = CoinbookHelper.Erhaltungsgrade[3].Erhaltung;
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["VZP"].HeaderText = CoinbookHelper.Erhaltungsgrade[5].Erhaltung;
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["STN"].HeaderText = CoinbookHelper.Erhaltungsgrade[6].Erhaltung;
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["STH"].HeaderText = CoinbookHelper.Erhaltungsgrade[7].Erhaltung;
            ...
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["SPREIS"].Appearance.AnyCell.CultureInfo = CultureInfo.GetCultureInfo(CoinbookHelper.Settings.Culture);
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["SPPREIS"].Appearance.AnyCell.CultureInfo = CultureInfo.GetCultureInfo(CoinbookHelper.Settings.Culture);
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["SSPREIS"].Appearance.AnyCell.CultureInfo = CultureInfo.GetCultureInfo(CoinbookHelper.Settings.Culture);
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["SSPPREIS"].Appearance.AnyCell.CultureInfo = CultureInfo.GetCultureInfo(CoinbookHelper.Settings.Culture);
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["VZPREIS"].Appearance.AnyCell.CultureInfo = CultureInfo.GetCultureInfo(CoinbookHelper.Settings.Culture);
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["VZPPREIS"].Appearance.AnyCell.CultureInfo = CultureInfo.GetCultureInfo(CoinbookHelper.Settings.Culture);
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["STNPREIS"].Appearance.AnyCell.CultureInfo = CultureInfo.GetCultureInfo(CoinbookHelper.Settings.Culture);
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["STHPREIS"].Appearance.AnyCell.CultureInfo = CultureInfo.GetCultureInfo(CoinbookHelper.Settings.Culture);
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["PPPREIS"].Appearance.AnyCell.CultureInfo = CultureInfo.GetCultureInfo(CoinbookHelper.Settings.Culture);
            grdAnzeige.GetTableDescriptor("ReportTable").Columns["GESAMT"].Appearance.AnyCell.CultureInfo = CultureInfo.GetCultureInfo(CoinbookHelper.Settings.Culture);
