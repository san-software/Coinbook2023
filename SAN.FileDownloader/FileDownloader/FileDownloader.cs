...
namespace SAN.FileDownloader
{
    ...
    public class FileDownloader : System.Object, IDisposable
    {
        ...
        public struct FileInfo
        {
            ...
            public FileInfo(String path, string ziel)
            {
                this.Path = path;
        ...
        private void downloadFile(Int32 fileNr)
        {
            ...
            FileStream writer = new FileStream(file.Ziel, System.IO.FileMode.Create);
        ...
        /// <summary>Gets or sets if the FileDownloader should support total progress statistics. 
        /// Note that when enabled, the FileDownloader will have to get the size of each file before 
        /// starting to download them, which can delay the operation.</summary>
        ...
        public int CurrentFileNumber { get { return m_fileNr + 1; } }
        public int TotalFileNumber { get { return m_files.Count; } }
